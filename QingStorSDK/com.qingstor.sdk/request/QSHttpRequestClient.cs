...
{
    class QSHttpRequestClient
    {
        private static ILog logger = QSLoggerUtil.setLoggerHanlder(typeof(QSHttpRequestClient).Name);
        private HttpClient client = null;
        private static QSHttpRequestClient ins;

        protected QSHttpRequestClient() 
        {
            intiOkHttpClient();
        }
